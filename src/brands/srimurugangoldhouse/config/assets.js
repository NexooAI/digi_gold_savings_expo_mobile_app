module.exports = {
  ...
  icons: {
    ...
    notificationIcon: require("../../../../assets/images/icon.png"),
  },
  
  // Background Images
  backgrounds: {
    login: require("../../../assets/images/bg_login.jpg"),
    new: require("../../../assets/images/bg_new.jpg"),
    menu: require("../../../assets/images/menu_bg.png"),
    savings: require("../../../assets/images/savingsbg.jpg"),
    goldPattern: require("../../../assets/images/gold_pattern.jpg"),
  },
  
  // Product Images
  products: {
    gold: require("../../../assets/images/bar.png"),
    silver: require("../../../assets/images/silver.png"),
    digiGold: require("../../../assets/images/digigoldproduct.png"),
  ...
  ui: {
    ...
    shop: require("../../../assets/images/shop.jpg"),
