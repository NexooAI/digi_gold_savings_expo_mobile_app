...
// Test script for Akila Jewellers brand
...
try {
  ...
  console.log('✅ Akila Jewellers Brand Configuration Test:');
  console.log('===========================================');
  ...
  console.log('\n✅ Akila Jewellers brand configuration test passed!');
  
} catch (error) {
  console.error('❌ Akila Jewellers brand configuration test failed:', error.message);
  process.exit(1);
} 