...
// Test script for Srimurugan Gold House brand
const path = require('path');

// Set environment variable for testing
process.env.BRAND_NAME = 'srimurugangoldhouse';
...
try {
  ...
  const { brandConfig, brandTheme, isFeatureEnabled } = require('../src/core/config/BrandConfig');
  
  console.log('✅ Srimurugan Gold House Brand Configuration Test:');
  console.log('=================================================');
  ...
  console.log('\n✅ Srimurugan Gold House brand configuration test passed!');
  
} catch (error) {
  console.error('❌ Srimurugan Gold House brand configuration test failed:', error.message);
  process.exit(1);
} 