...
// Replace the default brand with srimurugangoldhouse
content = content.replace(
  /let BRAND_NAME = process\.env\.BRAND_NAME \|\| global\.BRAND_NAME \|\| '[^']+';/,
  "let BRAND_NAME = process.env.BRAND_NAME || global.BRAND_NAME || 'srimurugangoldhouse';"
);

// Write the modified content back
fs.writeFileSync(brandConfigPath, content);

console.log('✅ Brand switched to srimurugangoldhouse');
